...
@section('crumbs', 'Communications | Email | Inbox')
...
<!-- HERO -->
        <section class="hero mail-hero">
          <div class="hero-text">
            ...
            <h1 class="hero-title">Inbox · <span class="accent">12 unread</span></h1>
        ...
        <section class="mail-shell" aria-label="Email">
          ...
          <aside class="mail-rail">
            ...
            <div class="mail-rail-storage">
              ...
              <div class="mail-storage-foot">49% used · <a href="#">Upgrade</a></div>
            </div>
          </aside>
          ...
          <section class="mail-list">
            <div class="mail-list-head">
              <div class="mail-list-toptools">
                <div class="mail-list-title">Inbox<span class="meta">12 UNREAD · 246 TOTAL</span></div>
            ...
            <div class="mail-list-scroll">
              <article class="mail-row is-unread">
                ...
                <div class="mail-row-body">
                  ...
                  <div class="mail-row-subject">Q2 launch plan — review before Thursday</div>
                  <div class="mail-row-preview">Hey John, attaching the latest deck and revised timeline. Two open questions on pricing — would love your call before…</div>
              ...
              <article class="mail-row is-active is-unread">
                ...
                <div class="mail-row-body">
                  ...
                  <div class="mail-row-subject">Dependency bump merged — all green</div>
              ...
              <article class="mail-row">
                ...
                <div class="mail-row-body">
                  ...
                  <div class="mail-row-preview">Thanks for sharing — added a few comments inline. Big +1 on consolidating the secondary palette. Should we ping Marcus before…</div>
                  <div class="mail-row-tags">
                    <span class="mail-tag work">Work</span>
                  </div>
                </div>
              ...
              <article class="mail-row is-unread">
                ...
                <div class="mail-row-body">
                  ...
                  <div class="mail-row-subject">Lisbon meetup — confirmed venue</div>
              ...
              <article class="mail-row">
                ...
                <div class="mail-row-body">
                  ...
                  <div class="mail-row-subject">Newsletter draft v3 — your edits welcome</div>
              ...
              <article class="mail-row">
                ...
                <div class="mail-row-body">
                  <div class="mail-row-top">
                    <div class="mail-row-from">Notion · Shared</div>
          ...
          <section class="mail-reader">
            ...
            <div class="reader-scroll">
              <header class="reader-head">
                <h1 class="reader-subject">Dependency bump merged — all green</h1>
              ...
              <article class="reader-card">
                ...
                <div class="reader-body">
                  ...
                  <ul>
                    ...
                    <li>CI passed on first run, no flaky tests this time around 🎉</li>
                  </ul>
                  <p>I've attached the bundle-size delta and the migration notes. The only thing I'd flag — the new FullCalendar release moves a few CSS variables around, so the dark-mode preview will need a quick visual pass. Sara already has a draft fix in <a href="#">PR #487</a>.</p>
                  ...
                  <p>Let me know if you spot anything off in staging — happy to roll back individual packages if needed.</p>
                  <p>— Leo</p>
                </div>
              ...
              <div class="reader-card">
                <div class="reader-collapsed">
                  ...
                  <div class="reader-collapsed-preview">Nice work — the bundle delta looks clean. Two small notes inline on the migration doc.</div>
...
<script>
(async function () {
  const api = window.ADMINATOR_API;
  if (!api || !api.messages) return;
  try {
    const res = await fetch(api.messages + '?per_page=12', {
    ...
    const list = document.querySelector('.email-list, [data-email-list], .mail-list');
    // Adminator email markup uses .mail-item rows — fill subject/preview when present
    const items = document.querySelectorAll('.mail-item, .email-item, .inbox-row');
    rows.slice(0, items.length).forEach(function (msg, i) {
      const el = items[i];
      if (!el) return;
      const name = el.querySelector('.mail-from, .email-from, .from-name');
      const subject = el.querySelector('.mail-subject, .email-subject, .subject');
      const preview = el.querySelector('.mail-preview, .email-preview, .preview');
      const time = el.querySelector('.mail-time, .email-time, .time');
      if (name) name.textContent = msg.name || name.textContent;
      if (subject) subject.textContent = msg.subject || '(no subject)';
      if (preview) preview.textContent = (msg.message || '').slice(0, 80);
      if (time && msg.created_at) time.textContent = new Date(msg.created_at).toLocaleString();
      el.dataset.messageId = msg.id;
    });
  } catch (e) {
    console.warn('Admin messages API unavailable', e);
  }
})();
</script>
@endpush
