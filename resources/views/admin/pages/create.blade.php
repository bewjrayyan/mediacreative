            ...
            <section class="saas-panel">
                ...
                <div class="saas-panel__body">
                    <div class="saas-field saas-rich-editor">
                        ...
                        <textarea class="saas-textarea @error('content') is-invalid @enderror" id="content" name="content" rows="14" required data-rich-editor data-rich-height="420" placeholder="Write the page content…">{{ old('content') }}</textarea>
