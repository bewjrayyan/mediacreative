...
<form id="pageForm" class="saas-editor" method="POST" action="{{ route('admin.pages.update', $page) }}" novalidate>
    @csrf
    @method('PUT')
    ...
    <header class="saas-toolbar">
        <div class="saas-toolbar__left">
            ...
            <div class="saas-toolbar__meta">
                ...
                <h1 class="saas-title" id="liveTitle">{{ $page->title }}</h1>
            </div>
            ...
            <section class="saas-panel">
                ...
                <div class="saas-panel__body">
                    <div class="saas-field">
                        ...
                        <input class="saas-input saas-input--lg @error('title') is-invalid @enderror" id="title" type="text" name="title" value="{{ old('title', $page->title) }}" required autocomplete="off" placeholder="e.g. About Us">
                    ...
                    <div class="saas-field">
                        ...
                        <div class="saas-input-group">
                            ...
                            <input class="saas-input @error('slug') is-invalid @enderror" id="slug" type="text" name="slug" value="{{ old('slug', $page->slug) }}" placeholder="auto-from-title">
                        </div>
                ...
                <div class="saas-panel__body saas-panel__body--tight">
                    <article class="saas-preview-card">
                        <div class="saas-preview-card__body">
                            <h3 class="saas-preview-card__title" id="previewTitle">{{ $page->title }}</h3>
                            <p class="saas-preview-card__client" id="previewSlug">/{{ $page->slug }}</p>
                        </div>
                    </article>
                </div>
            </section>
            ...
            <section class="saas-panel saas-panel--side">
                ...
                <div class="saas-panel__body saas-panel__body--tight">
                    <dl class="saas-meta">
                        <div>
                            <dt>Created</dt>
                            <dd>{{ $page->created_at?->format('M j, Y') ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt>Updated</dt>
                            <dd>{{ $page->updated_at?->diffForHumans() ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt>ID</dt>
                            <dd class="saas-mono">#{{ $page->id }}</dd>
                        </div>
                    </dl>
                </div>
            </section>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function syncTitle() {
    const val = titleInput.value.trim() || 'Untitled page';
