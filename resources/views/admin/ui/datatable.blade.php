...
@section('title', 'Data')
@section('active', 'datatable')
@section('crumbs', 'Components | Tables | Data')

@section('content')
<section class="hero">
          <div class="hero-text">
            <span class="eyebrow">Components · Tables</span>
            <h1 class="hero-title">Data table</h1>
            <p class="hero-sub">Sortable columns, pagination, search, row selection, and inline actions — built without DataTables, vanilla JS only.</p>
          </div>
